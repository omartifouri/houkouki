...
const FrTarifs = () => {
  ...
  const featureTooltips: { [key: string]: string } = {
    "Consultations juridiques illimitées*": "Posez toutes vos questions juridiques par téléphone ou visioconférence, sans limite de volume, dans le respect de votre vie privée. * Consultations illimitées dans le cadre d'un usage raisonnable et de bonne foi.",
