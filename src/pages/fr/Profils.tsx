...
const FrProfils = () => {
  ...
  const handleNavigateToTarifs = () => {
    ...
    setTimeout(() => {
      console.log('Tentative de scroll après navigation');
      console.log('URL actuelle:', window.location.href);
      
      // Scroll vers le haut de façon forcée
      window.scrollTo(0, 0);
      console.log('Scroll exécuté vers le haut');
      
      // Double vérification après un délai
      setTimeout(() => {
        window.scrollTo(0, 0);
        console.log('Second scroll exécuté');
      }, 500);
    }, 100);
  };
                  ...
                  <CardHeader>
                   ...
                   <CardContent>
                    ...
                    <Button variant="outline" className="mt-4 border-[#C0997A] text-[#C0997A] hover:bg-[#C0997A] hover:text-white" asChild>
                      <Link to="/fr/contact#top">Demander mon devis personnalisé</Link>
                    </Button>
                  </CardContent>
                </Card>
