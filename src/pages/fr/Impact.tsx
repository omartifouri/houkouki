...
const FrImpact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-100 via-red-50 to-orange-50">
      <FrenchNavigation />

      <div className="container mx-auto px-4 py-16">
        {/* Header Section */}
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-red-950 mb-8">Notre impact</h1>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <Card className="bg-white border-2 border-red-300 shadow-lg">
            <CardHeader className="text-center">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-red-600 text-white flex items-center justify-center shadow-lg">
                <Heart className="w-10 h-10" />
              </div>
              <CardTitle className="text-3xl font-bold text-red-950 mb-4">
            ...
            <CardContent className="text-center max-w-4xl mx-auto space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-red-950 mb-2">Accessible à tous</h3>
                  <p className="text-red-700">où qu'ils se trouvent</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-red-950 mb-2">Simple et compréhensible</h3>
                  <p className="text-red-700">sans jargon ni barrière administrative</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-red-950 mb-2">Inclusive</h3>
                  <p className="text-red-700">grâce à des dispositifs d'accompagnement solidaire</p>
                </div>
              </div>

              <div className="mt-12 p-6 bg-red-50 rounded-xl border border-red-300">
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-red-950 mb-4">Nos partenaires</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {partners.map((partner, index) => {
              ...
              return (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow duration-300 bg-white border-2 border-red-300">
                  <CardHeader>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <Card className="bg-white border-2 border-red-300">
            ...
            <CardContent>
              <div className="mb-8">
                <h3 className="text-xl font-bold text-red-950 mb-6 text-center">Ce que nous proposons :</h3>
                
                <div className="grid md:grid-cols-3 gap-6">
                  {solidarityActions.map((action, index) => {
                    const Icon = action.icon;
                    return (
                      <div key={index} className="text-center p-6 bg-red-50 rounded-lg border border-red-200 shadow-sm">
                        <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-red-100 flex items-center justify-center">
                          <Icon className="w-7 h-7 text-red-600" />
                        </div>
                        <h4 className="font-semibold text-red-950 mb-2">{action.title}</h4>
              ...
              <div className="text-center bg-red-50 border border-red-200 rounded-lg p-6 mb-8">
