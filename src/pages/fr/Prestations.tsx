    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl text-blue-600 mb-8">Un accompagnement juridique sur mesure</h2>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <section>
            <h2 className="text-3xl font-bold text-blue-800 mb-8 text-center">Nos principaux services</h2>
          ...
          {/* Et aussi... */}
          <section>
            <h2 className="text-3xl font-bold text-blue-800 mb-8 text-center">Et aussi…</h2>
