      ...
      <header className="border-b bg-white/95 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-blue-800">Houkouki</span>
          </div>
          <nav className="hidden md:flex space-x-6">
            <a href="#services" className="text-gray-600 hover:text-blue-600 transition-colors">Services</a>
            <a href="#prestation" className="text-gray-600 hover:text-blue-600 transition-colors">Prestations</a>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-blue-600"> accompagnement</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="text-lg px-8 py-4 border-blue-200 text-blue-700 hover:bg-blue-50">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-blue-100 hover:border-blue-300 transition-all duration-300 hover:shadow-lg">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-blue-800">Étudiants</CardTitle>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 border-2 border-blue-100">
                  <h4 className="font-semibold text-blue-800 mb-3">Espace personnel sécurisé</h4>
